            ...
            <div class="row mt-4 ">
                <div class="col-12 px-5">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="ms-3">Donacion / <strong>Modificar Donacion</strong></h5>
                    </div>
                    ...
                    <form>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                ...
                                <a class="btn-pasos mx-2" id="btnConfirmar" onclick="editarDonacion()"
                                    style="display: none;">Confirmar</a>
...
<div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content custom-modal-height">
        ...
        <h4 id="modalTitle">Donación modificada exitósamente.</h4>
...
document.getElementById("btnSiguiente").addEventListener("click", function() {
    var campos = [{
            id: 'titulo',
            errorId: 'error-titulo'
        },
        {
            id: 'objetivo',
            errorId: 'error-objetivo'
        },
        {
            id: 'fecha_limite',
            errorId: 'error-fecha'
...
function editarDonacion() {
    ...
    .catch(error => {
        ...
        alert('Hubo un error al editar la donación.');
    });
}


//Metodo para sacar info de la url
...
function cargarDetalles(idDonacion) {
    fetch(`http://localhost:8000/api/v1/donaciones/${idDonacion}`)
        ...
        .then(data => {
            ...
            fechaInput.value = fecha_limite;
            descripcionInput.value = descripcion;

            const nombreImagen = obtenerNombreImagen(imagen);
